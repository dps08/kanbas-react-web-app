...
export const USERS_API = `https://kanbas-node-server-app-divit-2bc1b0d87817.herokuapp.com/api/users`;
...
export const signin = async (credentials: any) => {
  ...
  export const findAllCourses=async()=>{
    const {data}=await axiosWithCredentials.get(`https://kanbas-node-server-app-divit-2bc1b0d87817.herokuapp.com/api/courses`);
    return data;
  }
